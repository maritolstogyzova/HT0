...
public class BuildingManager {
    ...
    public void build() throws IlluminanceTooMuchException, SpaceUsageTooMuchException{
        ...
        building.getRoom("Room 1").add(new Chair("So soft that you can drown in me", 1, 2));
        building.getRoom("Room 2").add(new Lamp(550));
        building.getRoom("Room 2").add(new Sofa("Lie on me gentle", 3, 4));
        building.getRoom("Room 2").add(new Table("Don't seat over here", 6));
        building.describe();
    }
}
